...
find_library(LLVM_Z_LIBRARY NAMES z)
find_library(TINFO_LIBRARY NAMES tinfo)
find_library(ZSTD_LIBRARY NAMES zstd)

set(LLVM_CLANG_LIBS ${CLANG_LIBS} ${LLVM_LIBS} ${CMAKE_THREAD_LIBS_INIT})
if(LLVM_Z_LIBRARY)
  list(APPEND LLVM_CLANG_LIBS ${LLVM_Z_LIBRARY})
endif()
if(TINFO_LIBRARY)
  list(APPEND LLVM_CLANG_LIBS ${TINFO_LIBRARY})
endif()
if(ZSTD_LIBRARY)
  list(APPEND LLVM_CLANG_LIBS ${ZSTD_LIBRARY})
endif()

mark_as_advanced(LLVM_Z_LIBRARY TINFO_LIBRARY ZSTD_LIBRARY)
